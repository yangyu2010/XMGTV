...
final public class User : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
        public func setLevel(_ value:Int64) -> User.Builder {
            self.level = value
            return self
        }
        @discardableResult
        public func clearLevel() -> User.Builder{
...
final public class TextMessage : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        fileprivate var userBuilder_:User.Builder! {
            didSet {
                builderResult.hasUser = true
            }
        }
        ...
        @discardableResult
        public func setUser(_ value:User!) -> TextMessage.Builder {
            self.user = value
            return self
        }
        @discardableResult
        public func mergeUser(value:User) throws -> TextMessage.Builder {
            if builderResult.hasUser {
                builderResult.user = try User.builderWithPrototype(prototype:builderResult.user).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.user = value
            }
            builderResult.hasUser = true
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> TextMessage.Builder {
            ...
            if let jsonValueUser = jsonMap["user"] as? Dictionary<String,Any> {
                resultDecodedBuilder.user = try User.Builder.decodeToBuilder(jsonMap:jsonValueUser).build()
...
final public class GiftMessage : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
        public func setUser(_ value:User!) -> GiftMessage.Builder {
            self.user = value
            return self
        }
        @discardableResult
        public func mergeUser(value:User) throws -> GiftMessage.Builder {
            if builderResult.hasUser {
                builderResult.user = try User.builderWithPrototype(prototype:builderResult.user).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.user = value
...
extension User: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> User {
        return try User.Builder().mergeFrom(data: data, extensionRegistry:ImmessageRoot.default.extensionRegistry).build()
    }
...
extension TextMessage.Builder: GeneratedMessageBuilderProtocol {
    public subscript(key: String) -> Any? {
        ...
        set (newSubscriptValue) { 
            switch key {
            case "user":
                guard let newSubscriptValue = newSubscriptValue as? User else {
                    return
                }
